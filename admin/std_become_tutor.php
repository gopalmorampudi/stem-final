...
<h1 class="box-title">
<a></i><b>Student Requests who want to become tutor </b></a>
</h1>
</div>	
<div class="box-body">
...
<tbody>
<?php
$sql="SELECT s.student_id, s.student_name, s.emailid, s.password, st.id, st.courses_list, st.phone_number, st.desp,st.working_hours,st.working_days  FROM student s, student_to_tutor st WHERE s.student_id = st.student_id AND st.status =  'pending'";
...
<input type="hidden" name="working_hours" value="<?=$res['working_hours']?>">
<input type="hidden" name="working_days" value="<?=$res['working_days']?>">
...
<td></td>
<td>
<h4><b>No New Requests Available</b></h4>
</td>
<td></td>
<td></td>
<td></td>
